...
describe('calculateMortgage', () => {
  ...
  describe('Camino 1: Datos obligatorios faltantes (salary = "")', () => {
    it('TC1: Debe manejar salary vacío y retornar maxHouseValue=0 con outstandingDebt negativo', () => {
      // Arrange
      const inputData = {
        salary: '',
        salary2: 0,
      ...
      expect(result.totalPaid).toBeLessThan(0);
  ...
  describe('Camino 4: Caso general con interés > 0 (fórmula de amortización)', () => {
    it('TC4: Debe calcular con fórmula de amortización cuando interest>0', () => {
      ...
      // Validar valores con toBeCloseTo para decimales
